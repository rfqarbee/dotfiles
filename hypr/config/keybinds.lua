...
hl.bind("Print", hl.dsp.exec_cmd("$XDG_DATA_HOME/scripts/grimshot.sh --monitor"))
hl.bind(mainMod .. "+ SHIFT+S", hl.dsp.exec_cmd("$XDG_DATA_HOME/scripts/grimshot.sh --swappy"))
hl.bind(mainMod .. "+ SHIFT+Print", hl.dsp.exec_cmd("$XDG_DATA_HOME/scripts/screen_record.sh"))
